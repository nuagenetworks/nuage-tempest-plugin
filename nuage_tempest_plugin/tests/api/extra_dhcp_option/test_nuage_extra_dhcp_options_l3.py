...
class NuageExtraDHCPOptionsOSManagedL3Test(
    ...
    @nuage_test.header()
    def test_nuage_os_mgd_l3_port_with_dhcp_opts_022_max_datagram_reassembly(
            self):
        self.\
    ...
    @nuage_test.header()
    def test_nuage_os_mgd_l3_port_with_dhcp_opts_032_router_solicitation(self):
    ...
    @nuage_test.header()
    def test_nuage_os_mgd_l3_port_with_dhcp_opts_094_client_interface_id(self):
