...
from nuage_commons import constants as p_const

from nuage_tempest_lib.common.base_mixin import NuageBaseMixin
from nuage_tempest_lib.services.fwaas import fwaas_client as client

CONF = config.CONF


class FWaaSClientMixin(NuageBaseMixin):
