...
class NuageExtraDHCPOptionsOSManagedL2Test(NuageExtraDHCPOptionsBaseL2):
    ...
    @nuage_test.header()
    def test_nuage_os_mgd_l2_port_with_dhcp_opts_022_max_datagram_reassembly(
            self):
        self.\
    ...
    @nuage_test.header()
    def test_nuage_os_mgd_l2_port_with_dhcp_opts_032_router_solicitation(self):
    ...
    def test_nuage_os_mgd_l2_port_with_dhcp_opts_034_trailer_encapsulation(
            self):
        self._check_nuage_crud_port_with_dhcp_opts_034_trailer_encapsulation()
    ...
    @nuage_test.header()
    def test_nuage_os_mgd_l2_port_with_dhcp_opts_094_client_interface_id(self):
    ...
    def test_nuage_os_mgd_l2_port_with_dhcp_opts_121_classless_static_route(
            self):
        self._check_nuage_crud_port_with_dhcp_opts_121_classless_static_route()
